...
@push('title')
<title>Kantipur Auto Center | Create Steps</title>
...
<div class="main-panel">
    <div class="content-wrapper">
        <h3><b>Create New Steps for Rack</b></h3><br>


        <div class="container border p-4 w3-round">
            <form method="post" action="{{url('admin/steps/create')}}">
                @csrf
                <input type="hidden" value="<?php echo date('Y-m-d'); ?>" name="date" type="text">

                <div class="row">
                    <div class="col-md-12">
                        <label>Step Name<sup class="text-danger fw-bold">*</sup></label>
                        <input class="w3-input w3-border w3-round" name="step" type="text" id="step">
                ...
                <button type="submit" class="btn btn-primary mb-2">Create New Step</button><br>
